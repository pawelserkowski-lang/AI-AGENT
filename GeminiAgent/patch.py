...
# Poprawiona zawartość (usunięto zagnieżdżone potrójne cudzysłowy)
NEW_RUN_PY = r"""import sys
import os
...
try:
    with open("run.py", "w", encoding="utf-8") as f:
        f.write(NEW_RUN_PY)
    print("✅ Pomyślnie zaktualizowano run.py")
    print("Możesz teraz uruchomić: python run.py")
except Exception as e:
